...
export function LibrarySection() {
  ...
  return (
    <section id="library" className="py-20 px-4 sm:px-6 lg:px-8 bg-background border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-white mb-8">Вся фонотека</h2>
