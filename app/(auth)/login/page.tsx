...
export default function LoginPage() {
  ...
  // const [transitionEnded, setTransitionEnded] = useState(false); // Больше не нужно для верстки
    ...
    <div className="bg-[#0f0f0f] flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center p-4 md:p-10">
      <div className="w-full max-w-sm md:max-w-4xl">
        <div className="flex flex-col gap-6 overflow-hidden">
          ...
          {/* ФУТЕР ФОРМЫ (Исправление "дергания"):
            Мы убрали {transitionEnded && ...}, теперь блок рендерится всегда, занимая место.
            Initial opacity 0 и задержка 1.5 сек позволяют ему появиться плавно, 
            когда основной переход уже почти закончился.
          */}
